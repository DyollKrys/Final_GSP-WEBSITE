...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2026 at 10:12 AM
...
--
-- Table structure for table `troop_registrations`
--

CREATE TABLE `troop_registrations` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `troop_registrations`
--
ALTER TABLE `troop_registrations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `troop_registrations`
--
ALTER TABLE `troop_registrations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
